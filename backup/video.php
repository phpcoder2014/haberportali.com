					...
					<div class="post-single" id="post">
						<div class="content-outer">
							<div class="content-inner">
								<div id="gallery">
								<h2 style="font-family: 'Rajdhani', sans-serif;">Ak Parti Karacabey Video Galeri</h2>
									<div class="separator"></div>
									<div id="gallery-list" class="row-fluid">
											<?php 
												require('includes/db.php');
												$query = $db->query("SELECT * FROM tbl_video", PDO::FETCH_ASSOC);
												if ( $query->rowCount() ){
													 foreach( $query as $row ){													
											?>										  
										  <a class="gallery-item" href="<?php echo $row['url']; ?>" title="AK PARTI GENCLIK KOLLARI" rel="gallery">
										  <p style="font-size:14px; padding:0px 0px; color:#000;"><?php echo $row['baslik']; ?></p>
										  <iframe width="187" height="206" src="<?php echo $row['url']; ?>" frameborder="0" allowfullscreen title="AK PARTI KADIN KOLLARI" rel="gallery"></iframe>
