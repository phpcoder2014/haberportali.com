					...
					<div class="post-single" id="post">
						<div class="content-outer">
							<div class="content-inner">
								<div id="gallery">
								<h2 style="font-family: 'Rajdhani', sans-serif;">SOSYAL FAALIYETLERIMIZDEN KARELER</h2>
									<div class="separator"></div>
									<div id="gallery-list" class="row-fluid">
											<?php 
												require('includes/db.php');
												$query = $db->query("SELECT * FROM tbl_foto", PDO::FETCH_ASSOC);
												if ( $query->rowCount() ){
													 foreach( $query as $row ){
													
											?>
															
										<a class="gallery-item" href="foto_galeri_detay.php?id=<?php echo $row['foto_id'];?>" title="<?php echo $row['baslik']; ?>">							  										
										<p style="padding:2px 2px; color:#000;"><?php echo $row['baslik']; ?></p>
										<img class="image-polaroid" src="img/genclik_kollari/<?php echo $row['resim'];?>" /></a>										
