					...
					<div class="post-single" id="post">
						<div class="content-outer">
							<div class="content-inner">
								<div id="gallery">
								<h2 style="font-family: 'Rajdhani', sans-serif;">Ak Parti Karacabey Kadın Kolları Resimleri</h2>
									...
									<div id="gallery-list" class="row-fluid" data-toggle="modal-gallery" data-slideshow="5000" data-target="#modal-gallery">
											<?php 
												...
												$query = $db->query("SELECT * FROM tbl_kadin_kollari", PDO::FETCH_ASSOC);
												if ( $query->rowCount() ){
													 foreach( $query as $row ){
													
											?>
										  <a class="gallery-item <?php echo $row['kategori'];?>" href="img/kadin_kollari/<?php echo $row['resim'];?>" title="AK PARTI KADIN KOLLARI" rel="gallery">
										  <p style="font-size:13px; padding:2px 2px; color:#000;"><?php echo $row['adi_soyadi']; ?></p>
										  <img class="image-polaroid" src="img/kadin_kollari/<?php echo $row['resim'];?>" alt="<?php echo $row['adi_soyadi']; ?>"></a>
											<?php }}?>							    
									</div>
